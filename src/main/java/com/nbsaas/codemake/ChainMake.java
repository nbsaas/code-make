...
public class ChainMake {
    ...
    private Context makeContext(Class<?> entity) {
        FormBean formBean = new FormBeanConver().convertClass(entity);
        ...
        Reflections reflections = new Reflections("com.nbsaas.codemake.handle");
